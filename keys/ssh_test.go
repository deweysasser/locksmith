...
func TestSSHPrivateKeyParse(t *testing.T) {
...
func TestSSHJSon(t *testing.T) {
	...
	json, error := key.Json()
	checke(t, error)
	assertStringsEquals(t, `{"Type":"ssh-rsa","PublicKeyString":"","PrivateKeyString":"","Comments":["dewey@FlynnRyder"],"Options":null}`, string(json))
