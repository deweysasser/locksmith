...
func (c *SSHHostConnection) Update(account data.Account, addBindings []data.KeyBindingImpl, removeBindings []data.KeyBindingImpl, keylib data.KeyFetcher) error {
...
func (c *SSHHostConnection) delKey(prefix string, path string, bindings []data.KeyBindingImpl, keylib data.KeyFetcher) error {
...
func (c *SSHHostConnection) addKey(prefix string, path string, addBindings []data.KeyBindingImpl, keylib data.KeyFetcher) error {
	if cmd, err := NewSshCmd(c.Connection); err != nil {
		return err
	} else {
